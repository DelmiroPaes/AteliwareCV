...
#include "visualizer.hpp"
 ...
 /**********************************************************************************************//**
  * \fn  EmotionBarVisualizer::EmotionBarVisualizer(std::vector<std::string> const& emotionNames, cv::Size size, cv::Size padding, double opacity, double textScale, int textThickness)
  *
  * \brief EmotionBarVisualizer
  *
  * \author  Delmiro Paes
  *
  ...
  * \param textThickness The text thickness.
  **************************************************************************************************/
...
/**********************************************************************************************//**
 * \fn  PhotoFrameVisualizer::PhotoFrameVisualizer(int bbThickness, int photoFrameThickness, float photoFrameLength)
 *
 * \brief PhotoFrameVisualizer
 *
 * \author  Delmiro Paes
 *
 * \param bbThickness         The bb thickness.
 * \param photoFrameThickness The photo frame thickness.
 * \param photoFrameLength    Length of the photo frame.
 **************************************************************************************************/
...
/**********************************************************************************************//**
 * \fn  HeadPoseVisualizer::HeadPoseVisualizer(float scale, cv::Scalar xAxisColor, cv::Scalar yAxisColor, cv::Scalar zAxisColor, int axisThickness)
 *
 * \brief HeadPoseVisualizer
 *
 * \author  Delmiro Paes
 *
 * \param scale         The scale.
 * \param xAxisColor    The axis color.
 * \param yAxisColor    The axis color.
 * \param zAxisColor    The axis color.
 * \param axisThickness The axis thickness.
 **************************************************************************************************/
...
/**********************************************************************************************//**
 * \fn  Visualizer::Visualizer(cv::Size const& imgSize, int leftPadding, int rightPadding, int topPadding, int bottomPadding): emotionVisualizer(nullptr), photoFrameVisualizer(std::make_shared<PhotoFrameVisualizer>()), headPoseVisualizer(std::make_shared<HeadPoseVisualizer>()), nxcells(0), nycells(0), xstep(0), ystep(0), imgSize(imgSize), leftPadding(leftPadding), rightPadding(rightPadding), topPadding(topPadding), bottomPadding(bottomPadding), frameCounter(0)
 *
 * \brief Visualizer
 *
 * \author  Delmiro Paes
